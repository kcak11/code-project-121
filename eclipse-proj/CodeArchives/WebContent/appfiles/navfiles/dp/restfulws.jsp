...
(for example https://www.mywebsite.com/users) where it is parsed. It could then
...
the URI https://www.mywebsite.com/users/Pieter%20Heijman to update the country
