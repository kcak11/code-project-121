...
<head>
  ...
  <% String baseURL=(String)session.getAttribute("staticBaseURL"); %>
    ...
    <script type="text/javascript">
      var feedbackURL = window.siteRequestor === 'KCAK11.COM' ? 'https://kcak11.com/codearchives/view?link=FEEDBACK' : ('<%=baseURL%>archive/Action/userFeedback/' + (Math.random() * 11).toString(36).split(".").join(""));
    </script>
    <script type="text/javascript">
      var bookmarkURL = window.location.hash;
      if (bookmarkURL != "") {
        document.cookie = 'N21foepcVS16Tar0b8_redir=' + encodeURIComponent(bookmarkURL.substring(1) + (Math.random()).toString(36).split(".").join("")) + ';path=/;secure=true;samesite=none;';
      }
    </script>
    <script type="text/javascript">
      (function () {
    ...
    <script type="text/javascript" src="archive/resources/scripts/app.js?v=<%=Math.random()%>"></script>
    <script type="text/javascript" src="archive/resources/scripts/jq.js"></script>
    <script type="text/javascript" src="archive/resources/scripts/ajaxSetup.js?v=<%=Math.random()%>"></script>
    ...
    <%-- <script type="text/javascript">var switchTo5x=false;</script>
      ...
      <script type="text/javascript">(typeof stLight !== 'undefined') && stLight.options({ publisher: '040e02b6-e1d5-4962-8e51-3c8c04aa424f' });</script>
      ...
      <script type="text/javascript">
        if (document.cookie.indexOf("cbca_hf37yt94g8f730") == -1) {
          var scriptSource = "%3Cscript%20type%3D%22text%2Fjavascript%22%3Evar%20switchTo5x%3Dfalse%3B%3C%2Fscript%3E%0D%0A%3Cscript%20type%3D%22text%2Fjavascript%22%20src%3D%22https%3A%2F%2Fw.sharethis.com%2Fbutton%2Fbuttons.js%22%3E%3C%2Fscript%3E%0D%0A%3Cscript%20type%3D%22text%2Fjavascript%22%3E(typeof%20stLight!%3D%3D'undefined')%20%26%26%20stLight.options(%7Bpublisher%3A'040e02b6-e1d5-4962-8e51-3c8c04aa424f'%7D)%3B%3C%2Fscript%3E%0D%0A";
...
<body>
  ...
  <script type="text/javascript" src="archive/resources/scripts/frameworkjs/content-framework-action-main.js?v=<%=Math.random()%>"></script>
...
/*Customizable & Configurable Scrolling Ends Here*/
  ...
  <script type="text/javascript">
    ...
    function hashCheck() {
      var localbmu = window.location.hash || "#archive/Action/home/";
