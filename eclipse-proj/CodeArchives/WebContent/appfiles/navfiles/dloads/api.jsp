...
<jsp:param name="docTitle" value="CodeArchives - API Downloads" />
</jsp:include>
...
<td><span style="font-size:22px;text-align:left;">API Downloads</span></td>
</tr>
</table>
<br/>
<%
...
<ul>
<li><span style="font-size:16px;cursor:pointer;border-bottom:2px solid #ff0000;" onclick="(function(){window.open('http://itextpdf.com/','ca_download_win'+new Date().getTime());})();">iText PDF Java API</span><br/><br/></li>
