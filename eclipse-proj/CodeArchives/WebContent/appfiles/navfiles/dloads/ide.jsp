...
<ul>
<li><span style="font-size:16px;cursor:pointer;border-bottom:2px solid #ff0000;" onclick="(function(){window.open('https://www.eclipse.org/downloads/','ca_download_win'+new Date().getTime());})();">Eclipse Integrated Development Environment</span><br/><br/></li>
<li><span style="font-size:16px;cursor:pointer;border-bottom:2px solid #ff0000;" onclick="(function(){window.open('https://www.jetbrains.com/idea/download/','ca_download_win'+new Date().getTime());})();">IntelliJ IDEA</span><br/><br/></li>
<li><span style="font-size:16px;cursor:pointer;border-bottom:2px solid #ff0000;" onclick="(function(){window.open('https://www.netbeans.org/','ca_download_win'+new Date().getTime());})();">NetBeans IDE</span><br/><br/></li>
</ul>
