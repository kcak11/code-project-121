...
<ul>
<li><span style="font-size:16px;cursor:pointer;border-bottom:2px solid #ff0000;" onclick="(function(){window.open('https://www.oracle.com','ca_download_win'+new Date().getTime());})();">Oracle Database</span><br/><br/></li>
<li><span style="font-size:16px;cursor:pointer;border-bottom:2px solid #ff0000;" onclick="(function(){window.open('https://dev.mysql.com/downloads/','ca_download_win'+new Date().getTime());})();">MySql Database</span><br/><br/></li>
</ul>
