...
}else if(fullURL.indexOf("https://code-archives.appspot.com")!=-1){
session.setAttribute("staticBaseURL","https://code-archives.appspot.com/");
...
}else if(fullURL.indexOf("https://www.code-archives.appspot.com")!=-1){
session.setAttribute("staticBaseURL","https://www.code-archives.appspot.com/");
