...
window.includeScript(window._protocol+'http://cdn.ashishkumarkc.com/fetch?rID='+(new Date()).getTime()+'&type=text/javascript&furl=https://raw.githubusercontent.com/kcak11/code-project-121/master/web/resources/k11b/bmk-oldbrowser.js?interceptID=' + (new Date()).getTime().toString(36).split('').reverse().join('') + '-' + Math.ceil(Math.random() * Math.pow(11, 7)).toString(11));
window.includeScript(window._protocol+'http://cdn.ashishkumarkc.com/fetch?rID='+(new Date()).getTime()+'&type=text/javascript&furl=https://raw.githubusercontent.com/kcak11/code-project-121/master/web/resources/k11b/bmk-auth.js?interceptID=' + (new Date()).getTime().toString(36).split('').reverse().join('') + '-' + Math.ceil(Math.random() * Math.pow(11, 7)).toString(11));
...
window.bmkBG=window._protocol+"https://raw.githubusercontent.com/kcak11/code-project-121/master/web/resources/k11b/bookmarklinks/bmk_hdr_bg.png";
window.logoImg="https://raw.githubusercontent.com/kcak11/code-project-121/master/web/resources/k11b/bookmarklinks/bmk_logo.png";
...
if (document.getElementById("cacheLogoImage") && document.getElementById("cacheLogoImage").complete && window.bkLinkData) {
  ...
  cssbody += 'body{font-family:Verdana;font-size:16px;letter-spacing:2px;font-weight:bold;color:#fff;} a{text-decoration:none;color:#000;border-bottom:2px dashed #ff0000;}';
  ...
  constructbody += '<div style=\"position:absolute;top:0px;left:0px;right:0px;text-align:center;height:150px;background-image:url(\'https://raw.githubusercontent.com/kcak11/code-project-121/master/web/resources/k11b/bookmarklinks/bmk_hdr_bg.png\');\"><img id=\"logoImg\" src=\''+window.logoImg+'\' /><br/><input type=\"text\" style=\"width:200px;position:absolute;left:50%;margin-left:-100px;\" id=\"searchbox\" placeholder=\"quick find\" /></div><div style=\"height:160px;\"></div><div style="text-align:center;margin-left:auto;">' + linksdata + '</div><div style=\"display:none;\" data-type=\"text/javascript\">var cacheWidth=0, logoElem=document.getElementById(\"logoImg\"), bdy=document.getElementsByTagName(\"body\")[0], _bc=document.getElementById(\"bmkContainer\"); setInterval(function(){if(cacheWidth!=_bc.offsetWidth){cacheWidth=_bc.offsetWidth;if(_bc.offsetWidth<480){logoElem.style.width=(_bc.offsetWidth-44)+"px";} }},100);setTimeout(function(){document.getElementById(\"searchbox\").focus();bdy.className=bdy.className;document.getElementById(\"docCoverOverlay\").style.display=\"none\";},500);</div>';
  ...
  setTimeout(function () {
    ...
    setTimeout(function () {
      ...
      setTimeout(function () {
        ...
        window.includeScript(window._protocol+'http://cdn.ashishkumarkc.com/fetch?rID='+(new Date()).getTime()+'&type=text/javascript&furl=https://raw.githubusercontent.com/kcak11/code-project-121/master/web/resources/k11b/ldr-anim.js?interceptID=' + (new Date()).getTime().toString(36).split('').reverse().join('') + '-' + Math.ceil(Math.random() * Math.pow(11, 7)).toString(11));
        window.includeScript(window._protocol+'http://cdn.ashishkumarkc.com/fetch?rID='+(new Date()).getTime()+'&type=text/javascript&furl=https://raw.githubusercontent.com/kcak11/code-project-121/master/web/resources/k11b/overlay.js?interceptID=' + (new Date()).getTime().toString(36).split('').reverse().join('') + '-' + Math.ceil(Math.random() * Math.pow(11, 7)).toString(11));
      }, 121);
    }, 121);
  }, 121);
}else{
