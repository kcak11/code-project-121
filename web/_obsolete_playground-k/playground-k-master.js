...
PlaygroundK.addCSS=function(){
  ...
  css+=".pgkCompatible #playgroundK_Master{background-image:url('https://raw.githubusercontent.com/kcak11/code-project-121/master/web/playground-k/files/images/pgkBG001.png');background-size:100% 100%;}";
  ...
  var chkAndAppend=function(){
    setTimeout(function(){
      try{
        ...
        PlaygroundK.includeJS("http://cdn.ashishkumarkc.com/fetch?rID="+(new Date()).getTime()+"&type=text/javascript&furl=https://raw.githubusercontent.com/kcak11/code-project-121/master/web/playground-k/playground-k-custom.js?interceptID="+(new Date()).getTime().toString(36).split("").reverse().join("")+"-"+Math.ceil(Math.random()*Math.pow(11,7)).toString(11));
      }catch(exjs){
        chkAndAppend();
      }
    },121);
...
PlaygroundK.addMasterHTML=function(){
  ...
  var htmlContent="<div id=\"pgkBlackBar\" style=\"position:absolute;top:0px;left:0px;right:0px;height:90px;background-color:#000;\"></div><div id=\"pgkHeader\">Playground<br/><br/><img id=\"pgkLogo\" src=\"https://raw.githubusercontent.com/kcak11/code-project-121/master/web/playground-k/files/images/avatar.png\" onclick=\"alert(decodeURIComponent('Powered%20by%3A%0A%0Ahttp%3A%2F%2Fashishkumarkc.com'));\" /></div><br/>";
